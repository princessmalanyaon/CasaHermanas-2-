            ...
            <div class="container-fluid bg-dark px-0">
                <div class="row gx-0">
                    <div class="col-lg-3 bg-dark d-none d-lg-block">
                        <a href="http://127.0.0.1/CasaHermanasBackend/index.php" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                        ...
                        <div class="row gx-0 bg-white d-none d-lg-flex">
                            ...
                            <div class="col-lg-5 px-5 text-end">
                                <div class="d-inline-flex align-items-center py-2">
                                    <a class="me-3" href="https://www.facebook.com/CasaHermanasLGP"><i class="fab fa-facebook-f"></i></a>
                                    <a class="me-3" href="https://www.facebook.com/CasaHermanasLGP"><i class="fab fa-twitter"></i></a>
                                    <a class="me-3" href="https://www.facebook.com/CasaHermanasLGP"><i class="fab fa-linkedin-in"></i></a>
                                    <a class="me-3" href="https://www.facebook.com/CasaHermanasLGP"><i class="fab fa-instagram"></i></a>
                                    <a class="" href="https://www.facebook.com/CasaHermanasLGP"><i class="fab fa-youtube"></i></a>
                                </div>
                            </div>
                        </div>
                        <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                            ...
                            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                <div class="navbar-nav mr-auto py-0">
                                    <a href="http://127.0.0.1/CasaHermanasBackend/index.php" class="nav-item nav-link active">Home</a>
        ...
        >
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="w-100" src="img/about7.jpg" alt="Image" />
              <div
              ...
              >
                <div class="p-3" style="max-width: 700px">
                  ...
                  <h1 class="display-3 text-white mb-4 animated slideInDown">
                    Where hospitality meets culinary delight
                  </h1>
                  <a
                     href="http://127.0.0.1/CasaHermanasBackend/booking.php"
      ...
      <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5 align-items-center">
              ...
              <a class="btn btn-primary py-3 px-5 mt-2" href="http://127.0.0.1/CasaHermanasBackend/about.php">Explore More</a>
            </div>
            <div class="col-lg-6">
              <div class="row g-3">
          ...
          <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <a class="service-item rounded" href="room.html">
                ...
                <p class="text-body mb-0" style="text-align: justify;">
                 Provide in-room dining, cleaning, 
                  and other amenities for a more comfortable hotel stay.
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
              <a class="service-item rounded" href="grazing.html">
                <div class="service-icon bg-transparent border rounded p-1">
                  <div
                    class="w-100 h-100 border rounded d-flex align-items-center justify-content-center"
                  >
                ...
                <h5 class="mb-3">Grazing Table</h5>
                <p class="text-body mb-0" style="text-align: justify;">
                   Arranges cheeses, meats, fruits, spreads,
                   and bread into a stunning and tasty centerpiece for any event.
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
              <a class="service-item rounded" href="bar.html">
                <div class="service-icon bg-transparent border rounded p-1">
                  <div
                    class="w-100 h-100 border rounded d-flex align-items-center justify-content-center"
                  >
                ...
                <h5 class="mb-3">Mobile Bar</h5>
                <p class="text-body mb-0" style="text-align: justify;">
                  Provides a fully equipped, staffed bar with 
                  customized drinks and cocktails for any event or gathering.
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
              <a class="service-item rounded" href="cafe.html">
                <div class="service-icon bg-transparent border rounded p-1">
                  <div
                    class="w-100 h-100 border rounded d-flex align-items-center justify-content-center"
                  >
                ...
                <h5 class="mb-3">Mobile Cafe</h5>
                <p class="text-body mb-0" style="text-align: justify;">
                  Offers a cozy atmosphere with a wide selection of specialty coffees it
                  all served with a touch of warmth and hospitality.
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
              <a class="service-item rounded" href="events.html">
                <div class="service-icon bg-transparent border rounded p-1">
                  <div
                    class="w-100 h-100 border rounded d-flex align-items-center justify-content-center"
                  >
                ...
                <h5 class="mb-3">Event Services</h5>
                <p class="text-body mb-0" style="text-align: justify;">
                  Cover everything from planning to logistics,
                   ensuring your conference or celebration is seamless and memorable.
                </p>
              </a>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
              <a class="service-item rounded" href="events.html">
                ...
                <h5 class="mb-3">Catering Services</h5>
                <p class="text-body mb-0" style="text-align: justify;">
                  Provide expertly crafted dishes,
                  and seamless service to make your event stress-free and unforgettable.
                </p>
              </a>
            </div>
          </div>
