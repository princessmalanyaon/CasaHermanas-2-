var Quickbeam = (function () {
  ...
  function init(att) {
    ...
    (function main() {
      ...
      [].forEach.call(
        document.querySelectorAll(".quickbeam-variant"),
        function (el) {
          if (el.checked) {
    ...
    function addProduct() {
      ...
      var cart_product =
        document.querySelector("#quick-cart-product-" + variantId) || false;
    ...
    function createProductBox(data) {
      var template =
        ...
        data.image +
        '">' +
        '<span class=" s1" style="background-color: ' +
        data.color +
        '; opacity: .5">' +
        data.price.trim() +
        "</span>" +
        ...
        data.id +
        '">0</span>' +
        '<span class="quick-cart-product-remove remove" data-id="' +
        data.id +
        '"></span>' +
    ...
    function createAnimatedObject(data) {
      ...
      var template =
        ...
        '<span class="s1" style="background-color: ' +
        color +
        '; opacity: .5; transition: 1000ms"></span>' +
        '<span class="s2"></span>' +
        "</div>";
    ...
    function getAnimationCoordinations(element) {
      ...
      var final = document
        .querySelector("#quick-cart-product-" + variantId)
